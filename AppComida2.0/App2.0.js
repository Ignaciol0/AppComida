spagetti_bolognesa = {'name':'spagetti_bolognesa','plato_unico': false,'type':'pasta','weight':1}
spagetti_carbonara = {'name':'spagetti_carbonara','plato_unico': false,'type':'pasta','weight':1}
arroz_cubana = {'name':'arroz_cubana','plato_unico': false,'type':'pasta','weight':1}
...
ensaladilla_rusa = {'name':'ensaladilla_rusa','plato_unico': false,'type':'pasta','weight':1}
...
primeros_platos = [spagetti_bolognesa,arroz_cubana,arroz_albondigas,macarrones_chorizo,pure_calabaza,pure_calabazin,pure_puerro,spagetti, arroz_curry,ensaladilla_rusa,ensalada_pasta,judias_verdes,coliflor,cocido,spagetti_carbonara,garbanzos,patatas_costilla,lentejas,alubias]
atun = {'name':'atun','plato_unico': false,'type':'pescado','weight':1}
salmon = {'name':'salmon','plato_unico': false,'type':'pescado','weight':1}
merluza = {'name':'merluza','plato_unico': false,'type':'pescado','weight':0.5}
panga = {'name':'panga','plato_unico': false,'type':'pescado','weight':0.5}
filetes_pollo = {'name':'filetes_pollo','plato_unico': false,'type':'carne','weight':2}
